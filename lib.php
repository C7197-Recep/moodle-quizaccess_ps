 ...
 */
function quizaccess_ps_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    $file = $fs->get_file($context->id, 'quizaccess_ps', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
        return false;
    }
